...
function printTodos(todos) {
    ...
    for (var i in todos ) {
        ...
        todo_button.classList.add('completedList');
        //todo_button.classList.add('btn-primary');
        todo_cell.innerHTML = todo + '&nbsp;<br/>';        
        todo_button.innerHTML = 'complete';
        todo_trash.setAttribute('onclick', 'deleteTodo(' + todo_id +')');
        todo_trashButton.innerHTML = 'Delete '     
        todo_trashButton.setAttribute('onclick', 'deleteTodo(' + todo_id +')');
        todo_trashButton.classList.add('first');
        //todo_trashButton.classList.add('btn-primary');
